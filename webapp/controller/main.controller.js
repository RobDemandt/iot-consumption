sap.ui.define([
	...
	return Controller.extend("odataconsumption.controller.main", {
      ...
      //      });
      //    //Second Tile
      //    var oTravelTile = oTiles[1].getId();
      //    sap.ui.getCore().byId(oTravelTile).attachPress(
      //      function(oEvent) {
      //        var app = sap.ui.getCore().byId("mainApp");
      //        var oContext = oEvent.getSource().getBindingContext();
      //        var page = app.getPage("DetailPage");
      ...
      //      });
      //    //Third Tile
      //    var oSalaryTile = oTiles[2].getId();
      //    sap.ui.getCore().byId(oSalaryTile).attachPress(
      //      function(oEvent) {
      //        var app = sap.ui.getCore().byId("mainApp");
      //        var oContext = oEvent.getSource().getBindingContext();
      //        var page = app.getPage("DetailPage");
      ...
      //      });
      //    //Fourth Tile
      //    var oReportTile = oTiles[3].getId();
      //    sap.ui.getCore().byId(oReportTile).attachPress(
      //      function(oEvent) {
      //        var app = sap.ui.getCore().byId("mainApp");
      //        var oContext = oEvent.getSource().getBindingContext();
      //        var page = app.getPage("DetailPage");
